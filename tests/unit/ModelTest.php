...
class AccessTrait extends \yii\codeception\DbTestCase
{
    ...
    public function testAccessRead()
    {
        ...
        $authManager->assign($authManager->getRole('Editor'), 2);
        ...
        $authManager->revoke($authManager->getRole('Editor'), 2);
    ...
    public function testAccessDomain()
    {
        ...
        // expect 5
        $products = Product::find()->all();
        $this->assertEquals(5, count($products), 'Public: cannot read the 5 expected products for "de"');
        ...
        // expect 4
        $products = Product::find()->all();
        $this->assertEquals(4, count($products), 'Public: cannot read the 4 expected products for "fr"');
    }
